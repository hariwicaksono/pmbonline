        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <!--<img src="<?php //echo base_url('assets/images/'.$site_logo);?>" width="160px" height="160px" class="user-image" alt="User Image">-->
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Hai, <?=$this->session->userdata('logged_in')['fullname'] ?></span>
            </a>
