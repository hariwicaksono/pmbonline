        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <?php echo $this->session->flashdata('info'); ?>
              ...
              <a href="<?=base_url('administrator/Kelulusan/report_maba/'.$prodi->kode_prodi)  ?>" type="button" target="_blank" class="btn bg-maroon"><i class="fa fa-print"></i> Cetak Data Mahasiswa Baru</a>
            ...
            <div class="box-footer">
              <a href="<?=base_url('administrator/Kelulusan') ?>" type="button" class="btn btn-danger"><i class="fa fa-reply"></i> Kembali</a>
            </div><!-- box-footer -->
            <!-- /.box-footer -->
          </div>
        </div>
